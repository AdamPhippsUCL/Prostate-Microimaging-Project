...
h5=plot(bvals+1*bshift, s(3,:,1), '--*', LineWidth = lw, color=[0 0 1], DisplayName = 'Lumen', HandleVisibility='on');

xticks(bvals); 
xticklabels(bvals)
ylim([-0.02, 0.7])
ylabel('Aggegrate signal estimate')
...
saveas(f1, fullfile(projectfolder, 'Thesis Figures', 'Benign Aggregate Signal Estimates', 'ESL_signals.png'))
