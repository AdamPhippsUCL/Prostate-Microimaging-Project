...
exportgraphics(f, ...
    fullfile(projectfolder, 'Thesis Figures', 'Parameter Maps', [sample_num '_MGE_Segmentation.png']) ...
...
exportgraphics(f, ...
    fullfile(projectfolder, 'Thesis Figures', 'Parameter Maps', [sample_num '_ADC_diff.png']) ...
    ,'BackgroundColor','none','Resolution',300)
...
exportgraphics(f, ...
    fullfile(projectfolder, 'Thesis Figures', 'Parameter Maps', [sample_num '_fs_diff.png']) ...
    ,'BackgroundColor','none','Resolution',300)
...
exportgraphics(f, ...
    fullfile(projectfolder, 'Thesis Figures', 'Parameter Maps', [sample_num '_Db_diff.png']) ...
    ,'BackgroundColor','none','Resolution',300)
